...
function BASS_SetNetConfig(option, value: DWORD): DWORD; stdcall; external 'bass.dll' name 'BASS_SetNetConfig';
{
...
function BASS_StreamCreate(freq, flags: DWORD; proc: Pointer; user: DWORD): HSTREAM; stdcall; external 'bass.dll' name 'BASS_StreamCreate';
{
