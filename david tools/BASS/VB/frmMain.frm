...
If BASS_GetStringVersion <> "1.6" Then ThrowError "BASS version 1.6 was not loaded": End
...
' Initialize CD
If BASS_CDInit(Nothing,BASS_DEVICE_LEAVEVOL) = BASSFALSE Then ThrowError "Can't initialize CD system"
